...
class ForecastAgent(BaseAgent):
    ...
    def __init__(self, llm_client: Any | None = None, horizon: int = 30) -> None:  # noqa: ANN401
    ...
    async def _execute(self, context: AgentContext, **kwargs: Any) -> dict:  # noqa: ANN401
        ...
        prophet_task = asyncio.create_task(run_prophet(df, date_col, target_col, self._horizon))
        arima_task = asyncio.create_task(run_arima(df, date_col, target_col, self._horizon))
