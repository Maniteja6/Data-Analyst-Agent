...
class ExecutionPlan(BaseModel):
    ...
    def create_default(
        ...
        if has_datetime:
            tasks.append(TaskNode(task_id="t_forecast", agent=AgentName.FORECAST, depends_on=["t_clean"]))
        ...
        return cls(
            ...
            tasks=tasks,
            estimated_duration_seconds=45 + (15 if has_datetime else 0) + (20 if numeric_cols >= 5 else 0),
        )
