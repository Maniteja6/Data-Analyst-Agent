...
class TestKPICalculator:
    ...
    def _make_profile(self, rows=100, cols=5, completeness=0.95, consistency=0.98, col_profiles=None):
        class _P:
            row_count          = rows
            column_count       = cols
    ...
    def test_basic_kpis_produced(self):
    ...
    def test_kpi_values_match_profile(self):
    ...
    def test_currency_column_produces_avg_kpi(self):
        class _Stats:
            mean = 1234.56
        class _CurrencyCol:
            column_name   = "revenue"
