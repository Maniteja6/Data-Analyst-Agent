...
class TestIQRDetector:
    ...
    def test_detects_outlier_below_lower_fence(self):
...
class TestAnomalyDetector:
    ...
    @pytest.mark.asyncio
    async def test_detect_returns_list(self, sample_df):
    ...
    @pytest.mark.asyncio
    async def test_negative_revenue_detected(self, sample_df):
    ...
    @pytest.mark.asyncio
    async def test_deduplication_removes_duplicate_alerts(self, sample_df):
        from backend.analytics_engine.anomaly_detection.anomaly_detector import AnomalyDetector
        detector = AnomalyDetector(run_isolation_forest=False)
