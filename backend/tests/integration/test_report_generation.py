...
class TestReportRendering:
    ...
    async def test_json_render(self):
        ...
        sample = {
            "id": "r1", "dataset_id": "d1", "session_id": "s1",
            "executive_summary": "Test summary.",
            "insights": [{"headline": "Revenue is growing", "business_impact": "high"}],
            "kpis": [], "anomaly_alerts": [], "forecasts": [], "recommendations": [],
        }
...
class TestResultFormatter:
    ...
    def test_markdown_table_from_rows(self):
    ...
    def test_summarise_single_value(self):
        from backend.analytics_engine.sql_engine.result_formatter import ResultFormatter
        rows   = [{"total": 42000}]
