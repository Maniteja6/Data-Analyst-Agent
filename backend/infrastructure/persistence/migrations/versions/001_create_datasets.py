...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_datasets_active", "datasets", ["status"],
    ...
    op.create_index("ix_agent_executions_input_hash", "agent_executions", ["agent_name", "input_hash"])
    op.create_index(
        "ix_agent_executions_cache_lookup",
        "agent_executions", ["agent_name", "input_hash"],
