...
class IQRDetector:
    ...
    def detect(self, df, column: str) -> list[IQRAnomaly]:
    ...
    def _detect_polars(self, df, column: str) -> list[IQRAnomaly]:
        import polars as pl
    ...
    def _detect_pandas(self, df, column: str) -> list[IQRAnomaly]:
        import numpy as np
